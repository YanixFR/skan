...
export const arrCarousel: Array<CarouselItemType> = [
    ...
    { image: "images/2.svg", text: "Доступный и понятный интерфейс" },
    { image: "images/1.svg", text: "Возможность получения данных из любой точки мира" },
    { image: "images/3.svg", text: "Гарантия достоверности полученных данных" },
];
